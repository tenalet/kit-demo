...
Reference implementation for [Tenalet Kit](https://registry.scalar.com/@tenalet/apis/tenalet-kit-api@latest). Demonstrates tolet creation, embedded tenant screening, report access, and webhook handling.

![Tenalet Kit embed widget](docs/embed-preview.png)

> For full API reference, embed SDK docs, and webhook schemas, see the **[Tenalet Kit API docs](https://registry.scalar.com/@tenalet/apis/tenalet-kit-api@latest)**.
...
- **Embed SDK** (`embed.js`) is loaded dynamically from Tenalet's app URL to render the screening widget in an iframe.
